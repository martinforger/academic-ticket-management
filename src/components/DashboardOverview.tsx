    ...
    <div className="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-8">
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">Métricas de registro académico en tiempo real y estado del sistema.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm font-semibold uppercase tracking-wider">Estudiantes Totales</p>
            <p className="text-3xl font-black text-slate-900 dark:text-white mt-1">1,240</p>
            <p className="text-slate-400 text-xs mt-2">Activos este semestre</p>
          </div>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-slate-400 text-xs mt-2">12 pendientes de revisión</p>
          </div>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm font-semibold uppercase tracking-wider">Tasa de Finalización</p>
            <p className="text-3xl font-black text-slate-900 dark:text-white mt-1">94.2%</p>
            <p className="text-slate-400 text-xs mt-2">Promedio 2.4 días</p>
          </div>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm ring-1 ring-red-500/20">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm font-semibold uppercase tracking-wider">Casos Urgentes</p>
            <p className="text-3xl font-black text-slate-900 dark:text-white mt-1">3</p>
            <p className="text-slate-400 text-xs mt-2">Requiere atención</p>
          </div>
        </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center">
              <div className="size-40 rounded-full border-[16px] border-slate-100 dark:border-slate-800 relative flex items-center justify-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-[10px] text-slate-400 font-bold uppercase">Aprobado</p>
                </div>
              </div>
              <div className="mt-8 grid grid-cols-2 gap-4 w-full">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-primary"></span>
                  <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">Aprobado (214)</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-amber-400"></span>
                  <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">Pendiente (42)</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-slate-300 dark:bg-slate-700"></span>
                  <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">Borrador (12)</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
                  <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">Completado (28)</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
            ...
            <button className="text-primary text-sm font-bold hover:underline">Ver Toda la Actividad</button>
          </div>
          <div className="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            <div className="p-4 flex items-center gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-slate-900 dark:text-white">
                  <span className="font-bold">Sarah Jenkins</span> actualizó Solicitud de Historial <span className="font-mono text-primary">#882</span>
                </p>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Coordinador Académico • hace 12 minutos</p>
              </div>
              <div className="flex items-center gap-3">
                <span className="px-2 py-1 text-[10px] font-black uppercase tracking-wider rounded bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">En Revisión</span>
            ...
            <div className="p-4 flex items-center gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-slate-900 dark:text-white">
                  <span className="font-bold">Sistema</span> Auditoría de Graduación Automatizada completada para <span className="font-bold">Cohorte 2024</span>
                </p>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Tarea Automatizada • hace 45 minutos</p>
              </div>
              <div className="flex items-center gap-3">
                <span className="px-2 py-1 text-[10px] font-black uppercase tracking-wider rounded bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400">Completado</span>
                <button className="material-symbols-outlined text-slate-400 hover:text-slate-600">more_vert</button>
              </div>
            </div>
            {/* Activity Item 3 */}
            <div className="p-4 flex items-center gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-slate-900 dark:text-white">
                  <span className="font-bold">Marcus Webb</span> marcó Caso de Inscripción <span className="font-mono text-primary">#1024</span> como urgente
                </p>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Oficina de Registro • hace 2 horas</p>
              </div>
              <div className="flex items-center gap-3">
                <span className="px-2 py-1 text-[10px] font-black uppercase tracking-wider rounded bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400">Urgente</span>
                <button className="material-symbols-outlined text-slate-400 hover:text-slate-600">more_vert</button>
              </div>
            </div>
            {/* Activity Item 4 */}
            <div className="p-4 flex items-center gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-slate-900 dark:text-white">
                  <span className="font-bold">Elena Rodriguez</span> aprobó 14 sustituciones de cursos para <span className="font-bold">Lic. CompSci</span>
                </p>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Jefe de Departamento • hace 5 horas</p>
              </div>
              <div className="flex items-center gap-3">
                <span className="px-2 py-1 text-[10px] font-black uppercase tracking-wider rounded bg-primary/10 text-primary">Aprobado</span>
                <button className="material-symbols-outlined text-slate-400 hover:text-slate-600">more_vert</button>
              </div>
            </div>
          </div>
