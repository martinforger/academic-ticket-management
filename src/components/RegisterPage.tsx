        ...
        <div className="bg-background-light dark:bg-background-dark font-display text-[#0d141b] dark:text-slate-100 min-h-screen flex flex-col relative">
            ...
            <header className="w-full flex items-center justify-between border-b border-solid border-[#e7edf3] dark:border-slate-800 px-6 py-4 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md shadow-sm z-20 animate-fadeInDown">
                ...
                <button
                    ...
                    className="bg-primary/10 hover:bg-primary/20 text-primary px-4 py-2 rounded-lg text-sm font-bold transition-all hover:scale-105 active:scale-95 flex items-center gap-2"
                >
            ...
            <main className="flex-1 tech-grid relative flex items-center justify-center px-4 py-8 z-10">
                <div className="w-full max-w-md glass-morphism dark:glass-morphism rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/50 dark:border-slate-800/50 p-8 @container animate-scaleIn relative overflow-hidden group">
                    ...
                    <div className="text-center mb-8 animate-fadeInUp animate-delay-100">
                        ...
                        <h2 className="text-2xl font-black tracking-tight text-[#0d141b] dark:text-white mb-1">Crear Cuenta</h2>
                        <p className="text-[#4c739a] dark:text-slate-400 text-sm">Regístrate para acceder al sistema</p>
                    </div>

                    {success ? (
                        <div className="text-center space-y-6 animate-scaleIn">
                            <div className="p-6 rounded-2xl bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 border border-green-100 dark:border-green-900/30">
                                <span className="material-symbols-outlined text-5xl mb-3 block">mark_email_read</span>
                                <p className="text-lg font-black mb-2">¡Registro exitoso!</p>
                                <p className="text-sm">Por favor, revisa tu correo electrónico para confirmar tu cuenta antes de iniciar sesión.</p>
                            </div>
                            <button
                                onClick={onBackToLogin}
                                className="w-full bg-primary hover:bg-primary/90 text-white font-black py-4 px-6 rounded-2xl transition-all shadow-xl shadow-primary/25 hover-glow active:scale-95"
                            >
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div className="flex flex-col gap-1.5 animate-fadeInUp animate-delay-200">
                                <label className="text-[10px] font-bold uppercase tracking-widest text-[#4c739a] dark:text-slate-400 ml-1" htmlFor="fullName">
                                    Nombre Completo
                                </label>
                                <div className="group/input relative">
                                    <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#4c739a] text-xl group-focus-within/input:text-primary transition-colors">person</span>
                                    <input
                            ...
                            {/* Password */}
                            <div className="flex flex-col gap-1.5 animate-fadeInUp animate-delay-400">
                            ...
                            <button
                                disabled={loading}
                                className="w-full bg-primary hover:bg-primary/90 disabled:opacity-50 text-white font-black py-3.5 px-6 rounded-2xl transition-all shadow-xl shadow-primary/25 flex items-center justify-center gap-3 active:scale-[0.98] animate-fadeInUp animate-delay-500 hover-glow mt-2"
                                type="submit"
                            >
                                {loading ? (
                                    ...
                                    <>
                                        <span className="text-base">Registrar Cuenta</span>
                    ...
                    {/* Card Footer */}
                    <div className="mt-8 pt-6 border-t border-slate-200/50 dark:border-slate-700/50 text-center animate-fadeInUp animate-delay-600">
                        <p className="text-xs text-[#4c739a] dark:text-slate-400">
                            ¿Ya tienes una cuenta?{' '}
                            <button onClick={onBackToLogin} className="text-primary font-black hover:underline ml-1">
                                Inicia sesión aquí
                            </button>
                        </p>
                    </div>
            ...
            <footer className="w-full py-4 px-10 border-t border-[#e7edf3] dark:border-slate-800 bg-white/50 dark:bg-background-dark/50 z-20">
                <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex gap-6 items-center">
                        <p className="text-xs text-[#4c739a] font-medium italic opacity-70">Hecho con ❤️ por <a href="https://github.com/martinforger" className="hover:text-primary transition-colors">@martinforger</a></p>
                    </div>
                </div>
            </footer>
        </div>
