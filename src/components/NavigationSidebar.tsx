...
export const NavigationSidebar: React.FC<NavigationSidebarProps> = ({ activePage, onNavigate }) => {
  const navItems = [
    ...
    { id: 'registration', label: 'Registration', icon: 'assignment' },
      ...
      <div className="flex flex-col h-full p-4">
        ...
        <div className="flex items-center gap-3 mb-8 px-2">
          ...
          <div className="flex flex-col">
            <h1 className="text-slate-900 dark:text-white text-base font-bold leading-none">CE School</h1>
            <p className="text-slate-500 dark:text-slate-400 text-xs font-medium">Management Portal</p>
          </div>
        </div>
        ...
        <div className="mt-auto border-t border-slate-100 dark:border-slate-800 pt-4">
          ...
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-xs truncate">Dean of Engineering</p>
            </div>
          </div>
        </div>
      </div>
